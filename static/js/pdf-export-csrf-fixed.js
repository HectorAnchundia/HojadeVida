 ...
 * Con manejo mejorado del token CSRF
 */
                ...
                <form id="pdf-export-form" method="post" action="/generate-pdf/" target="_blank">
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includePersonal" id="pdf-include-personal" checked>
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includeExperience" id="pdf-include-experience" checked>
                            <span class="pdf-checkbox"></span>
                            Experiencia Laboral
                        </label>
                    </div>
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includeAcademic" id="pdf-include-academic" checked>
                            <span class="pdf-checkbox"></span>
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includeProducts" id="pdf-include-products" checked>
                            <span class="pdf-checkbox"></span>
                            Productos Laborales
                        </label>
                    </div>
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includeEducation" id="pdf-include-education" checked>
                            <span class="pdf-checkbox"></span>
                            Cursos y Títulos
                        </label>
                    </div>
                    ...
                    <div class="pdf-export-suboptions" id="pdf-education-options">
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeStudies" id="pdf-include-studies" checked>
                                <span class="pdf-checkbox"></span>
                                Estudios Realizados
                            </label>
                        </div>
                        ...
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeCourses" id="pdf-include-courses" checked>
                                <span class="pdf-checkbox"></span>
                                Cursos Realizados
                            </label>
                        </div>
                        ...
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeEducationDocs" id="pdf-include-education-docs" checked>
                                <span class="pdf-checkbox"></span>
                    ...
                    <div class="pdf-export-option">
                        <label class="pdf-checkbox-container">
                            <input type="checkbox" name="includeRecognition" id="pdf-include-recognition" checked>
                            <span class="pdf-checkbox"></span>
                            Reconocimientos
                        </label>
                    </div>
                    ...
                    <div class="pdf-export-suboptions" id="pdf-recognition-options">
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeGeneralRecognition" id="pdf-include-general-recognition" checked>
                                <span class="pdf-checkbox"></span>
                        ...
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeWorkRecognition" id="pdf-include-work-recognition" checked>
                                <span class="pdf-checkbox"></span>
                        ...
                        <div class="pdf-export-option">
                            <label class="pdf-checkbox-container">
                                <input type="checkbox" name="includeRecognitionDocs" id="pdf-include-recognition-docs" checked>
                                <span class="pdf-checkbox"></span>
                                Incluir todos los documentos
                            </label>
                        </div>
